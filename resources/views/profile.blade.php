  ...
  <div class="row">
    <div class="col-75">
      <div class="container">
        @if(session('success'))
        <div class="row">
            <div class="col col-12" style="text-align: center;background: #d16513;padding: 13px;color: white;border-radius: 6px;">
         ...
         {{ csrf_field() }}
          <div class="row input-wrap">
            <div class="col-75">
              ...
              <div class="row">
                <div class="col-50">
                  <input type="text" placeholder="Email" id="email" value="{{auth()->user()->email}}" name="email">
                </div>
                <div class="col-50">
                  <input type="password" placeholder="Contraseña (Dejar en blanco para mantener)" id="password" name="password">
                </div>
              </div>
            </div>
            <div class="col-50">
              <h3>Dirección</h3>
              <input type="text" id="fname" value="{{auth()->user()->name}}" placeholder="Nombre completo" name="name">
              <div class="row">
                <!--div class="col-50">
                  <input type="text" id="dni" placeholder="DNI" name="dni">
                </div-->
                <div class="col-50">
                  <input type="text" id="phone" value="{{auth()->user()->phone}}" placeholder="Teléfono" name="phone">
                </div>
              </div>
              
              <input type="text" id="adr" placeholder="Dirección" value="{{auth()->user()->address}}" name="address">
              <input type="text" id="city" placeholder="Ciudad" value="{{auth()->user()->city}}" name="city">
          ...
          <input type="submit" value="Actualizar" class="btn btn-form btn-primary display-4">
        </form>
      </div>
    </div>
  </div>
