          ...
          <div class="total-price text-right" style="    margin-bottom: 72px;">
            <div class="container">
              <div class="justify-content-end align-items-center">
                ...
                <!--button onclick="if (confirm('Â¡Solo para bogota!')) window.location.href='/contra-entrega';" class="btn btn-form btn-primary display-4">
                    Pagar Contraentrega
                    
                    </button-->
                <button type="button" class="btn btn-form btn-primary display-4" data-toggle="modal" data-target="#myModal">Confirmar Contraentrega</button>
                @php
                  $hash = str_random(25);
                @endphp
                    <form method="post" id="form" action="https://checkout.payulatam.com/ppp-web-gateway-payu/">
                      <input name="merchantId"    type="hidden"  value="782678"   >
                      <input name="accountId"     type="hidden"  value="789493" >
                      <input name="description"   type="hidden"  value="Compra de productos en Express Nutrition"  >
                      <input name="referenceCode" type="hidden"  value="{{$hash}}" >
                      <input name="amount"        type="hidden"  value="{{$total}}"   >
                      <input name="tax"           type="hidden"  value="0"  >
                      <input name="taxReturnBase" type="hidden"  value="0" >
                      <input name="currency"      type="hidden"  value="COP" >
                      <input name="signature"     type="hidden"  value="{{md5('Bie0RurUw23vM7SFzZkKVDI36N~782678~'.$hash.'~'.$total.'~COP')}}">
                      ...
                      <input style="    display: none;" name="Submit"        type="submit"  value="Confirmar Pago2" class="btn btn-form btn-primary display-4" >
                    </form>
                    <button class="btn btn-form btn-primary display-4" onclick="addOrder();">Confirmar Pago</button>
                    @else
                    <button type="button" class="btn btn-form btn-primary display-4" data-toggle="modal" data-target="#myModal">Pagar Contraentrega</button>
...
const addOrder = () => {
  $.post('/addOrder', $("#form").serialize(), function(response){  
    ...
    placeholder: "Selecciona tu sabor",
    allowClear: false
});
});</script>
   @endsection  